//
//  SSCheckoutCustomerDetailViewController.m
//  iPOS
//
...
@interface SSCheckoutCustomerDetailViewController()
...
@implementation SSCheckoutCustomerDetailViewController
@synthesize customer;
...
- (void) handleEditButton:(id)sender {
	if (customer != nil) {
		...
		SSCheckoutCustomerFormDataSource *customerFormDataSource = [[[SSCheckoutCustomerFormDataSource alloc] initWithModel:customerFormModel] autorelease];
		SSCheckoutCustomerEditViewController *customerEditViewController = [[[SSCheckoutCustomerEditViewController alloc] initWithNibName:nil bundle:nil formDataSource:customerFormDataSource] autorelease];
...
- (void) handleConfirmButton:(id)sender {
	...
	if (self.customer != nil) {
        ...
        [[SSOrderCart sharedInstance] bindCustomerToOrder:custCpy];
        ...
        UIViewController *cartItemsController = [self getOnNavStackByType:[SSCartItemsViewController class]];
