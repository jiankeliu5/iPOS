...
@interface CartItemsViewController : ExtUIViewController <LineaDelegate, AddItemViewDelegate, ExtUIViewControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
	iPOSFacade *facade;
